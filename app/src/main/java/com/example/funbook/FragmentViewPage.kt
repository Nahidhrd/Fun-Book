...
import com.example.funbook.databinding.AddPostDialogBinding
import com.example.funbook.databinding.FragmentViewPageBinding
...
class FragmentViewPage : BaseFragment<FragmentViewPageBinding>(FragmentViewPageBinding::inflate) {

    val userlist: MutableList<User> = mutableListOf()
    val postList: MutableList<PostWithUser> = mutableListOf()
    lateinit var adapter: PostAdapter

    val postImageLink = MutableLiveData<String>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mAuth.signOut()
            findNavController().navigate(R.id.action_fragment_ViewPage_to_loginFragment)
                ...
                myRef.putFile(fileUri).addOnCompleteListener { task ->
                    ...
                    if (task.isSuccessful) {
                        ...
                        myRef.downloadUrl.addOnSuccessListener { link ->
                            ...
                            postImageLink.postValue(link.toString())
    ...
    private fun addPostBottomSheetDialog() {
        ...
        postImageLink.observe(viewLifecycleOwner) {
            if (it is String) {
